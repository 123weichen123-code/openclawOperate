...
- Added logged operation wrappers for skill installs, cron edits, cron creation, and model switches.
- Updated the dashboard activity feed to read recent events from `growth-log`.
